...
if (NOT DEFINED ENABLE_NNDEPLOY_INFERENCE_RKNN)
  ...
  foreach(INSTALL_LIB ${INSTALL_LIBS})
    if (INSTALL_LIB MATCHES ".*(tiff|jasper|webp|opencv).*so")
        if (NOT INSTALL_LIB MATCHES ".*opencv.*so\\.3\\.4")
            message(STATUS "installing ${INSTALL_LIB} to ${NNDEPLOY_INSTALL_LIB_PATH}")
